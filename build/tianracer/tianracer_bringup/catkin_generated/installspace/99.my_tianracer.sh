...
: ${TIANRACER_BASE_BAUDRATE:=115200}  # 115200, 460800 
...
: ${TIANRACER_VIDEO_DEVICE:=/dev/video0} # /dev/video0 for most of the usb_cams.If you want init usb_cam in jet_cam, this should be set to none.
#/dev/video2 if using realsense, none
: ${TIANRACER_LIDAR:=richbeam} # rplidar, velodyne_vlp16, osight, rslidar, hokuyo, sick, richbeam, etc..
: ${TIANRACER_LIDAR_MODEL:=} # a1, a2, a3, iexxx, vlp16, etc...
: ${TIANRACER_LIDAR_PORT:=} # /dev/ttyUSB0 
