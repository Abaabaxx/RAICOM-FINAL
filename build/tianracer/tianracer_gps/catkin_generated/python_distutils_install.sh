...
echo_and_run cd "/home/tianbot/tianbot_ws/src/tianracer/tianracer_gps"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/tianbot/tianbot_ws/src/tianracer/tianracer_gps/setup.py" \
     \
    build --build-base "/home/tianbot/tianbot_ws/build/tianracer/tianracer_gps" \
    install \
    --root="${DESTDIR-/}" \
