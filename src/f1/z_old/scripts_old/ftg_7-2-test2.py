...
class FollowTheGapNode:
    def __init__(self):
        ...
        # --- 【新增】一个Publisher，用于发布打包好的FtgData消息 ---
        self.ftg_data_pub = rospy.Publisher('/ftg/debug_data', FtgData, queue_size=1)

        rospy.loginfo("FTG Computation Node has been initialized and is waiting for mode commands.")
    ...
    def process_lidar(self, data):
        ...
        # 【旧代码，已删除】
        # self.publish_visualization(ftg_data_package)
