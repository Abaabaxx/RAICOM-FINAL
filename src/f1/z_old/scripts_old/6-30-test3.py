...
python /home/lby/tianbot_ws/src/f1/scripts/6-30-test3.py
"""
...
if __name__ == '__main__':
    try:
        ...
        odom_sub = rospy.Subscriber('/tianracer/odom', Odometry, pos_callback)
        scan_sub = rospy.Subscriber('/tianracer/scan', LaserScan, radar_callback)
